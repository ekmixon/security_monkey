...
INTERNET_ELB = {
    "Arn": f"{ARN_PREFIX}:elasticloadbalancing:{AWS_DEFAULT_REGION}:012345678901:loadbalancer/MyELB",
    "Attributes": {
    ...
    "AvailabilityZones": [AWS_DEFAULT_REGION],
    "BackendServerDescriptions": [],
    "CanonicalHostedZoneNameID": "Z3DZXE0Q79N41H",
    "CreatedTime": "2015-07-07 19:15:06.490000+00:00",
    "DNSName": f"MyELB-1885487881.{AWS_DEFAULT_REGION}.elb.amazonaws.com",
    "HealthCheck": {
        "HealthyThreshold": 2,
        "Interval": 30,
    ...
    "ListenerDescriptions": [
        ...
        },
        {
            ...
            "SSLCertificateId": f"{ARN_PREFIX}:iam::012345678901:server-certificate/somecert-20170511-20180511",
        },
    ],
    ...
    "SourceSecurityGroup": {"OwnerAlias": "012345678901", "GroupName": "MySG"},
    "Subnets": ["subnet-19999999"],
    "Tags": [
        {
            "Value": f"{ARN_PREFIX}:cloudformation:{AWS_DEFAULT_REGION}:012345678901:stack/STACK/xxxxxxxxxxxxxxxxxxx",
...
class ELBTestCase(SecurityMonkeyTestCase):
    ...
    def test_process_reference_policy(self):
        ...
        self.assertEqual(issues, {'Insecure TLS'})
